...
public class Pemilihan2Percobaan2No01 {
    public static void main(String[] args) {
        ...
        int pilihan_Menu;
        String member,qris;
        double harga, diskon, total_bayar, Jenis_pembayaran_qris;
        ...
        System.out.print("pembayran menggunakan qris (y/n) ? = ");
        qris = absen01.nextLine();
        System.out.println("-----------------------------------------");
        ...
        if (member.equalsIgnoreCase("y")) {
            ...
            if (qris.equals("y")) {
                total_bayar -= 1000;
                System.out.println("Potongan harga  menggunakan QRIS: Rp. 1000");
            }
